...
| 4 | Self-containment proof (fresh scratch worktree of main+commit) | import quote_app OK; full suite PASS_PLACEHOLDER; vitals fast 8/8 PLACEHOLDER |
| 5 | Counterfactual on the LATEST tape (8/1, skew fix armed) | see below |
| 6 | Arming lines staged COMMENTED in the live local yaml with the derivation quoted | operator flips at a restart |
