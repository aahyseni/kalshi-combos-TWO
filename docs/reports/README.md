...
| 2026-07-09 | **MLB/baseball SGP finalization — phase 1 DONE** | **classification VERIFIED · ρ triple-verified · measurement tranche RUNNING** | exactly 9 combo-eligible families (KS/HIT/HR/HRR/TB/RFI all UNKNOWN→+0.6 today); KXMLBTOTAL = GAME total, TEAMTOTAL untradeable (strands +0.367/−0.380 as reference-only); 3 live misclass bugs found (F5TOTAL/F5SPREAD/SERIESGAMETOTAL); shipped ρ reproduced EXACTLY at 3 independent levels, 21-season stable; NEW blocker: event_mutually_exclusive gates all baskets; staged code in `docs/calibration/staged_mlb_props.md` (rule-8 gated) — [report](2026-07-09-mlb-classification-and-rho-verification.md) |
