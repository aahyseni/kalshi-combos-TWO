...
| 2026-07-11 | **Phase 4 CAPSTONE — fresh 3-bucket re-backtest** | **MLB+mixed+WC-per-combo DONE · WC per-print running** | fresh window (+19% tape, +40% MLB per-print rows): MLB 0.34¢/93% + prop 0.66 vs 1.37¢ GATE PASS; mixed 0.70¢/87.5% (was 0.74/85.2) w/ **airtight isolation** (6/742 fairs changed, all MLB-prop, all improved; WC bit-identical ×19,016) + cross-sport independence EXACT + mixed settlement **15.28% YES vs 15.25¢ fair**; WC backbone reproduces at +14% sample; gather KeyError repo-fixed `2163642`; artifact v3 same URL — [report](2026-07-11-phase4-capstone.md) |
