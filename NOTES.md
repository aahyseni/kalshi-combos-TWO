...
Clean-data re-validation (WNBA/MLB/NBA re-fetched with the hardened full-ladder fetcher) is the remaining "verify afterwards" step; K9 numbers appended when the re-fetch completes.
