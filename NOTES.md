...
Clean-data re-validation (WNBA/MLB/NBA re-fetched with the full-ladder fetcher) is the follow-up "verify afterwards" pass; numbers appended when the re-fetch + adversarial re-verify complete. 713 tests green, mypy strict, ruff clean.
